...
3. On round two, watch the revised repro produce `PASS_BOTH`. Point out that a passing script alone does not isolate the regression.
4. On round three, watch the final repro fail 5/5 on the reported build and pass 5/5 on the reference build.
